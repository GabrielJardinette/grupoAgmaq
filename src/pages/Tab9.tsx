        ...
        <IonContent color="medium">
            <IonList>
             ...
             <IonItem key={i}>          
              ...
              <IonToolbar color="dark">
                <IonTitle color="light">COMPRA REALIZADA</IonTitle>
                </IonToolbar>
                      <IonCard>
                        <IonCardTitle>Você finalizou sua compra</IonCardTitle>
                        <IonCardContent>
                            Aguarde a confirmação da compra e o contato da ING Guindastes por e-mail
                            <IonButton expand="block" color="warning" href='Tab1'>
              <IonIcon slot="start" icon={home}></IonIcon>
              INÍCIO
            </IonButton>   
